...
import edu.ntnu.idatt2001.paths.asset.ImageAsset;
...
/**
 * The purpose of this class is to create a PathsAssetStore by reading a .pathsassets-file
 * and the contents of its directory. <br>
 * <br>
 *
 * <p>This class is mainly focused around two methods:
 * <code>parsePathsAssetStore</code> and <code>getErrorsFromLastParse</code>.
 * The former is the actual parser method.
 * The latter returns a collection of errors that caused the last call to
 * <code>parsePathsAssetStore</code> to fail.
 * Note that every time <code>parsePathsAssetStore</code> is called,
 * the errors from the parsing-operation before will be lost.
 */
public class PathsAssetStoreParser {
     ...
     *
     * @return <code>true</code> if any errors occurred, or <code>false</code>
    ...
    /**
     * Returns a collection of the errors that occurred during the last call to
     * <code>parsePathsAssetStore</code>.
     *
    ...
    /**
     * Attempts to collect all assets specified in <code>assetRegisterData</code>
     * from the directory <code>assetDirectoryPath</code>, and stores them as
     * Asset-objects in a PathsAssetStore.
     *
     * @param assetRegisterData  Textual data in line-separated key-value format,
     *                           telling us the key and URI/filepath
     *                           of each asset we expect to find within the specified
     *                           <code>assetDirectoryPath</code>.
